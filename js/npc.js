// js/npc.js
import { game, checkDailyReset } from "./core.js?v=420eb015";
import { toast, renderStoryLog } from "./ui.js?v=420eb015";
import { getNodeById } from "./world.js?v=420eb015";
import { crewTick } from "./crew.js?v=420eb015";
