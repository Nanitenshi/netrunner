// js/npc.js
import { game, checkDailyReset } from "./core.js?v=c3a9ba95";
import { toast, renderStoryLog } from "./ui.js?v=c3a9ba95";
import { getNodeById } from "./world.js?v=c3a9ba95";
import { crewTick } from "./crew.js?v=c3a9ba95";
