// js/npc.js
import { game, checkDailyReset } from "./core.js?v=1a3a9bca";
import { toast, renderStoryLog } from "./ui.js?v=1a3a9bca";
import { getNodeById } from "./world.js?v=1a3a9bca";
import { crewTick } from "./crew.js?v=1a3a9bca";
import { saveNow } from "./save.js?v=1a3a9bca";
