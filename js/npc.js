// js/npc.js
import { game, checkDailyReset } from "./core.js?v=b31a0ade";
import { toast, renderStoryLog } from "./ui.js?v=b31a0ade";
import { getNodeById } from "./world.js?v=b31a0ade";
import { crewTick } from "./crew.js?v=b31a0ade";
