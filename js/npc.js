// js/npc.js
import { game, checkDailyReset } from "./core.js?v=40a4aaa4";
import { toast, renderStoryLog } from "./ui.js?v=40a4aaa4";
import { getNodeById } from "./world.js?v=40a4aaa4";
import { crewTick } from "./crew.js?v=40a4aaa4";
