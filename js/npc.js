// js/npc.js
import { game, checkDailyReset } from "./core.js?v=1d12397a";
import { toast, renderStoryLog } from "./ui.js?v=1d12397a";
import { getNodeById } from "./world.js?v=1d12397a";
import { crewTick } from "./crew.js?v=1d12397a";
