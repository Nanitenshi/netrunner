// js/npc.js
import { game, checkDailyReset } from "./core.js?v=b1cb64f4";
import { toast, renderStoryLog } from "./ui.js?v=b1cb64f4";
import { getNodeById } from "./world.js?v=b1cb64f4";
import { crewTick } from "./crew.js?v=b1cb64f4";
