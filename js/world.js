// js/world.js
import { game } from "./core.js?v=40a4aaa4";
import { toast, updateNodeList, openSignalPanel, closeNodesPanel } from "./ui.js?v=40a4aaa4";
import { openNpcDialog } from "./npc.js?v=40a4aaa4";
import { PALETTES, makeCitizenPalette, getSprites, drawCharacterAt, facingToDir } from "./sprites.js?v=40a4aaa4";
import { sfx } from "./sfx.js?v=40a4aaa4";
