// js/npc.js
import { game, checkDailyReset } from "./core.js?v=f1640fb9";
import { toast, renderStoryLog } from "./ui.js?v=f1640fb9";
import { getNodeById } from "./world.js?v=f1640fb9";
import { crewTick } from "./crew.js?v=f1640fb9";
