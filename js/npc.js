// js/npc.js
import { game, checkDailyReset } from "./core.js?v=bba082b9";
import { toast, renderStoryLog } from "./ui.js?v=bba082b9";
import { getNodeById } from "./world.js?v=bba082b9";
import { crewTick } from "./crew.js?v=bba082b9";
