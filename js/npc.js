// js/npc.js
import { game, checkDailyReset } from "./core.js?v=2b94d4a4";
import { toast, renderStoryLog } from "./ui.js?v=2b94d4a4";
import { getNodeById } from "./world.js?v=2b94d4a4";
import { crewTick } from "./crew.js?v=2b94d4a4";
