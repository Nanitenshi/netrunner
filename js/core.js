...
import {
  ...
  worldIsManualPan,
  worldRecenterCamera
} from "./world.js?v=7a81dc60";

import { initUI, uiTick, toast, setComms } from "./ui.js?v=7a81dc60";
import { loadSave, saveNow, resetSave } from "./save.js?v=7a81dc60";
import { openNpcDialog, npcTick } from "./npc.js?v=7a81dc60";
import { initCrewUI, closeCrewOverlay } from "./crew.js?v=7a81dc60";
import { initEncounters } from "./encounters.js?v=7a81dc60";
import { unlockAudio } from "./sfx.js?v=7a81dc60";
import { musicSetEnabled, musicSetIntensity, musicSetTension } from "./music.js?v=7a81dc60";
