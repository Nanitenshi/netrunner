// js/npc.js
import { game, checkDailyReset } from "./core.js?v=ea10dd0d";
import { toast, renderStoryLog } from "./ui.js?v=ea10dd0d";
import { getNodeById } from "./world.js?v=ea10dd0d";
import { crewTick } from "./crew.js?v=ea10dd0d";
