// js/npc.js
import { game, checkDailyReset } from "./core.js?v=98b9add7";
import { toast, renderStoryLog } from "./ui.js?v=98b9add7";
import { getNodeById } from "./world.js?v=98b9add7";
import { crewTick } from "./crew.js?v=98b9add7";
