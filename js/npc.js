// js/npc.js
import { game, checkDailyReset } from "./core.js?v=575e20f0";
import { toast, renderStoryLog } from "./ui.js?v=575e20f0";
import { getNodeById } from "./world.js?v=575e20f0";
import { crewTick } from "./crew.js?v=575e20f0";
