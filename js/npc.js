// js/npc.js
import { game, checkDailyReset } from "./core.js?v=905511bd";
import { toast, renderStoryLog } from "./ui.js?v=905511bd";
import { getNodeById } from "./world.js?v=905511bd";
import { crewTick } from "./crew.js?v=905511bd";
