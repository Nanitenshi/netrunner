// js/npc.js
import { game, checkDailyReset } from "./core.js?v=dd71de14";
import { toast, renderStoryLog } from "./ui.js?v=dd71de14";
import { getNodeById } from "./world.js?v=dd71de14";
import { crewTick } from "./crew.js?v=dd71de14";
