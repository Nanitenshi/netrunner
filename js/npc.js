// js/npc.js
import { game, checkDailyReset } from "./core.js?v=1a3ba971";
import { toast, renderStoryLog } from "./ui.js?v=1a3ba971";
import { getNodeById } from "./world.js?v=1a3ba971";
import { crewTick } from "./crew.js?v=1a3ba971";
