// js/npc.js
import { game, checkDailyReset } from "./core.js?v=d2e18f59";
import { toast, renderStoryLog } from "./ui.js?v=d2e18f59";
import { getNodeById } from "./world.js?v=d2e18f59";
import { crewTick } from "./crew.js?v=d2e18f59";
